...
<div class="header">
      ...
      <div class="top-console">
          ...
          <form class="search-block" action="index.php">
            ...
            <input id="search_input" autocomplete="off" name="query" value="<?= @$_GET['query'] ?>" type="text" placeholder="<?= langs('look for', 'Я ищу...') ?>" />
            <button type="submit"><?= langs('btn.search', 'Найти') ?></button>
            <ul class="result-list" id="result_list">
              <!-- <li><a href="#">vbbvcxs</a></li>
              <li><a href="#">dffgggg</a></li>
              <li><a href="#">dsaaaaa</a></li>
              <li><a href="#">vbbvcxs</a></li>
              <li><a href="#">dffgggg</a></li>
              <li><a href="#">dsaaaaa</a></li> -->
            </ul>
              ...
              <div class="top-icons">
                <div class="counter">
                  <?= isset($_SESSION['count']) ? $_SESSION['count'] : '' ?>
                    ...
                    <svg viewBox="0 0 24 24" id="icon-user-simple" class="<?php if (!auth_check()) echo 'js-open-modal-nocheck' ?> profile-icon" data-target="modal_login">
                    ...
                    <a class="header-cart-link" href="?action=cart">
                ...
                <ul class="profile">
                  <?php if (auth_check()): ?>
                    <li><a href="action=user-page">profile</a></li>
