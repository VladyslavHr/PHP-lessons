...
<div class="container">
    ...
    <div class="list-group">
        ...
        <form action="" method="POST">
            ...
            <a href="{{ route('pharmacies.categories.show', [ 'pharmacy' => $pharmacy, 'category' => $category->id] ) }}" class="list-group-item list-group-item-action d-flex align-items-center justify-content-between">
